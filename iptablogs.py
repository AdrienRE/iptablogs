...
class Interface(object):
    ...
    try:
        ...
        class Lignelimitee:
            ...
            It is used to create similar objects as Lignelog but initialized using lists instead of strings.
            We browse the dictionary dico_colonnes to create an attribute name,
