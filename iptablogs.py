...
class Interface(object):
    def __init__(self):
        # This list will hold the lines read from the log file. Because it's going to used in a method of this class and
        # also because we don't want to use a global variable, it's registered here as an attribute of the
        ...
        self.checkbox_dernieres_nb_lignes_a_afficher = ttk.Checkbutton(self.trame_options, text="Dernières lignes ?",
        ...
        self.label_actions_experimentales = ttk.Label(self.trame_options, text="EXPERIMENTAL : (LIRE LE README !!!)")
        ...
        def __init__(self, ligne_a_decouper, n_ligne):
         ...
         """
            ...
            try:
                ...
                icmp_n_sequence = int()
            try:
                longueur_datagramme = int(search("(?: PROTO=UDP.*)(?<= LEN=)(\\d*)(?= )", ligne_a_decouper).groups()[0])
            except (AttributeError, IndexError):
    ...
    def appeler_fenetre_erreur(self, err, msg="Erreur inconnue"):
    ...
    def lire_fichier_log(self):
        ...
        try:
            ...
            self.appeler_fenetre_erreur(erreur, "Fichier log introuvable, veuillez lire le README.")
        return liste_lignes
    ...
    def remplir_tableau(self):
        ...
        try:
            ...
            self.appeler_fenetre_erreur(err_remplir_tableau, "Liste non initialisée, veuillez cliquer sur Initialiser.")
    ...
    def filtrer_liste(liste_a_filtrer, liste_filtres):
        ...
        It then compares each line "attribute" to the filters' ones. If it finds a match, the line is added to the list
